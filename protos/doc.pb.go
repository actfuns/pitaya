...
type Doc struct {
	...
	Doc           string                 `protobuf:"bytes,1,opt,name=doc,proto3" json:"doc"`
...
const file_doc_proto_rawDesc = "" +
	"\n" +
	"\tdoc.proto\x12\x06protos\"\x17\n" +
	"\x03Doc\x12\x10\n" +
	"\x03doc\x18\x01 \x01(\tR\x03docB<Z)github.com/topfreegames/pitaya/pkg/protos\xaa\x02\x0eNPitaya.Protosb\x06proto3"
