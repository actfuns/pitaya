...
func (UnimplementedPitayaServer) SessionBindRemote(context.Context, *BindMsg) (*Response, error) {
	return nil, status.Error(codes.Unimplemented, "method SessionBindRemote not implemented")
}
...
func RegisterPitayaServer(s grpc.ServiceRegistrar, srv PitayaServer) {
	// If the following call panics, it indicates UnimplementedPitayaServer was
