...
// Source: github.com/topfreegames/pitaya/v2/cluster (interfaces: ServiceDiscovery)
//
// Generated by this command:
//
//	mockgen github.com/topfreegames/pitaya/v2/cluster ServiceDiscovery
//
...
func (m *MockServiceDiscovery) IsConnected(ctx context.Context) bool {
	m.ctrl.T.Helper()
...
func (mr *MockServiceDiscoveryMockRecorder) IsConnected(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockServiceDiscovery) SetServerState(state int32) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetServerState", state)
}

// SetServerState indicates an expected call of SetServerState.
func (mr *MockServiceDiscoveryMockRecorder) SetServerState(state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetServerState", reflect.TypeOf((*MockServiceDiscovery)(nil).SetServerState), state)
}
