...
// Source: github.com/actfuns/pitaya/v2/agent (interfaces: Agent,AgentFactory)
//
// Generated by this command:
//
//	mockgen github.com/actfuns/pitaya/v2/agent Agent,AgentFactory
//
...
import (
	...
	acceptor "github.com/actfuns/pitaya/v2/acceptor"
	agent "github.com/actfuns/pitaya/v2/agent"
...
func (m *MockAgent) AnswerWithError(ctx context.Context, mid uint, err error) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "AnswerWithError", ctx, mid, err)
}

// AnswerWithError indicates an expected call of AnswerWithError.
func (mr *MockAgentMockRecorder) AnswerWithError(ctx, mid, err any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AnswerWithError", reflect.TypeOf((*MockAgent)(nil).AnswerWithError), ctx, mid, err)
}
...
func (m *MockAgent) Kick(ctx context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockAgentMockRecorder) Kick(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Kick", reflect.TypeOf((*MockAgent)(nil).Kick), ctx)
}

// Push mocks base method.
func (m *MockAgent) Push(route string, v any) error {
	m.ctrl.T.Helper()
...
func (mr *MockAgentMockRecorder) Push(route, v any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAgent) ResponseMID(ctx context.Context, mid uint, v any, isError ...bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockAgentMockRecorder) ResponseMID(ctx, mid, v any, isError ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAgent) SendRequest(ctx context.Context, serverID, route string, v any) (*protos.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAgentMockRecorder) SendRequest(ctx, serverID, route, v any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendRequest", reflect.TypeOf((*MockAgent)(nil).SendRequest), ctx, serverID, route, v)
}
...
func (m *MockAgent) SetStatus(state int32) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetStatus", state)
}

// SetStatus indicates an expected call of SetStatus.
func (mr *MockAgentMockRecorder) SetStatus(state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetStatus", reflect.TypeOf((*MockAgent)(nil).SetStatus), state)
}
...
func (m *MockAgentFactory) CreateAgent(conn acceptor.PlayerConn) agent.Agent {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAgent", conn)
	ret0, _ := ret[0].(agent.Agent)
	return ret0
}

// CreateAgent indicates an expected call of CreateAgent.
func (mr *MockAgentFactoryMockRecorder) CreateAgent(conn any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAgent", reflect.TypeOf((*MockAgentFactory)(nil).CreateAgent), conn)
}
