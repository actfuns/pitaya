...
//
//	mockgen -package mocks github.com/actfuns/pitaya/v2/session Session,SessionPool
//
...
func (m *MockSession) PushPacket(ctx context.Context, pkt []byte) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PushPacket", ctx, pkt)
	ret0, _ := ret[0].(error)
	return ret0
}

// PushPacket indicates an expected call of PushPacket.
func (mr *MockSessionMockRecorder) PushPacket(ctx, pkt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PushPacket", reflect.TypeOf((*MockSession)(nil).PushPacket), ctx, pkt)
}
