...
```
go install github.com/actfuns/pitaya/v2/pitaya-cli
```
...
To implement those routes you can find a complete example in the
[cluster_protobuf example](/examples/demo/cluster_protobuf).
