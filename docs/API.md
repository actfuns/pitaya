...
Below is a very barebones example of a handler definition, for a complete working example, check the [cluster demo](https://github.com/actfuns/pitaya/tree/master/examples/demo/cluster).

```go
import (
  "github.com/actfuns/pitaya"
  "github.com/actfuns/pitaya/component"
)
...
For a complete working example, check the [cluster demo](https://github.com/actfuns/pitaya/tree/master/examples/demo/cluster).
